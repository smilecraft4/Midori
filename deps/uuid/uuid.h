...
[[nodiscard]] inline bool operator==(uuid const& lhs, uuid const& rhs) noexcept { return lhs.data == rhs.data; }

[[nodiscard]] inline bool operator!=(uuid const& lhs, uuid const& rhs) noexcept { return !(lhs == rhs); }
...
class basic_uuid_random_generator {
   public:
    ...
    [[nodiscard]] uuid operator()() {
        ...
        for (int i = 0; i < 16; i += 4) *reinterpret_cast<uint32_t*>(bytes + i) = distribution(*generator);
